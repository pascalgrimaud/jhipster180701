...
describe('Operation e2e test', () => {
    ...
    it('should load Operations', () => {
        ...
        expect(operationComponentsPage.getTitle()).toMatch(/jhipster180701App.testRootOperation.home.title/);
    });
    ...
    it('should load create Operation page', () => {
        ...
        expect(operationUpdatePage.getPageTitle()).toMatch(/jhipster180701App.testRootOperation.home.createOrEditLabel/);
