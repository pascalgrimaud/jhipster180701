...
import { Jhipster180701TestModule } from '../../../../test.module';
import { LabelDeleteDialogComponent } from 'app/entities/test-root/label/label-delete-dialog.component';
    ...
    describe('Label Management Delete Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [Jhipster180701TestModule],
